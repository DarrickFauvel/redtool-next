...
const GeneratorPage = () => {
  ...
  return (
    <>
      ...
      {barcodeValue && (
        <section className="relative flex flex-col w-min mx-auto items-center mt-8 px-4 py-2 bg-white text-black/80 border border-gray-400 rounded-xl animate-slide-up shadow-xl">
